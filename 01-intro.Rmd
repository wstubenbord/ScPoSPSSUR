...
If you are taking this course, you probably don't need an explanation of why `R` is useful or why it may be in your best interest to take this course.

So I won't beleaguer the point: yes, `R` will make you fabulously rich; yes, it will help you make new friends; and yes, it will allow you to escape your own mortality. Or, at the very least, it will allow you to do some interesting things with data, which is nearly as nice.

To get started with `R`, you will need to install two things:
...
![](docs/_main_files/figure-html/RStudio%20clean%20install.png)
...
![](docs/_main_files/figure-html/Base%20R%20GUI.PNG)
...
![](docs/_main_files/figure-html/RStudio%20console%20box.png)
...
![](docs/_main_files/figure-html/RStudio%20console_x1.png)
...
What happens when you press `Enter`? You have created a **vector**. Like other types of variables in `R`, a vector is an **object**. A vector is a type of object which holds a set of values of the same type. In this case, the object `x` contains a set of numbers: $\{1,2,3,4,5\}$.
...
![](docs/_main_files/figure-html/RStudio_Opening%20an%20R%20Script%20File.png)

You should now have a window open in RStudio which looks like this:

![](docs/_main_files/figure-html/RStudio_Opened%20RScript.png)
...
![](docs/_main_files/figure-html/RStudio_Commenting%20in%20an%20R%20Script%20file.png)

Now, save your R Script somewhere on your computer. Go to File \> Save As, then choose a safe place on your computer to store it (I recommend creating a folder for this course), give your file a name, and press save. I called mine "hello_world".
...
![](docs/_main_files/figure-html/RStudio_Run%20button.png)
