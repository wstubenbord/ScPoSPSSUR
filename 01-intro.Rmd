...
If your screen looks like the image below, it means that you've accidentally opened RGui, a basic graphical user interface included with `R`, and not RStudio. We're always going to be working in RStudio for this class, so close out of RGui and open RStudio instead.

![](docs/_main_files/figure-html/Base%20R%20GUI.PNG)

## Using the Console

Now the fun begins. The RStudio window you've opened consists of a few different parts. The most important of these right now is the console [pane](https://docs.posit.co/ide/user/ide/guide/ui/ui-panes.html "An explanation of some of the different panes in RStudio.") (highlighted below).
...
![](docs/_main_files/figure-html/RStudio_Run button.png)
