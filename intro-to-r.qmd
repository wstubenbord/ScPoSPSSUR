...
[^intro-to-r-1]: Unlike other programming languages, like Python, `R` does not use zero-indexing. This means that our first value in any data structure is always indexed as `1` .
...
If you've made it this far in one sitting, well done! Here's another thing you can try. Enter the following in the console:
