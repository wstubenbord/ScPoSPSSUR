...
[^04-using-the-tidyverse-3]: Anytime you install packages, do it directly in the console. If someone needs to run your code, they should see the `library()` calls in the beginning of your code after your header and will know whether they need to install additional packages or not. RStudio also has a helpful auto-prompt feature that will inform you of missing packages.
...
[^04-using-the-tidyverse-4]: If you are interested, see here for more on the differences: [https://www.tidyverse.org/blog/2023/04/base-vs-magrittr-pipe](https://www.tidyverse.org/blog/2023/04/base-vs-magrittr-pipe/#){.uri}
...
![](docs/_main_files/figure-html/GSS_Respondent-1.png)
