...
2.  Now create another vector called `second_vector` which contains the `first_vector` and an `NA` value. Try it on your own first, then click on this footnote to see the answer.[^02-working-with-data-in-r-1]
