...
![](images/RStudio clean install.png)
...
![](images/RStudio console box.png)
...
1.  Can you find the median of the vector `x`?[^01-intro-1]

2.  What happens when you multiply a vector by a number?

3.  Can you create a new vector which consists of only letters?

[^01-intro-1]: Some functions are easy to guess, like `median()` , but others can be false cognates just like in a spoken language (e.g., `mode()` doesn't do what you might expect it to do). We'll talk more about functions and how to figure out what they do in the next chapter.
...
![](images/RStudio_Opening an R Script File.png)

You should now have a window open in RStudio which looks like this:

![](images/RStudio_Opened RScript.png)
...
![](images/RStudio_Commenting in an R Script file.png)
